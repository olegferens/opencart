...
class ControllerProductCategory extends Controller {
	public function index() {
		...
		if ($category_info) {
			...
			$data['text_compare'] = ((isset($this->session->data['compare'])&&(count($this->session->data['compare'])>0)) ? sprintf($this->language->get('text_compare'), count($this->session->data['compare'])) : "");
